...
HD_PWD='/opt/PROJECTS/SILISCALE/lab-ext-sig-sync/lab-external-signal-synchronization.2023.2/lab-external-signal-synchronization/lab-external-signal-synchronization.runs/synth_1'
cd "$HD_PWD"
